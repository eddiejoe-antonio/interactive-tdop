...
const ConclusionOne = () => {
    return ( 
        <div className='w-full h-screen bg-[#010101] px-4 font-sans text-white'>
            <div className='max-w-[1240px] grid md:grid-cols-12'>
                <div className='flex flex-col md:col-start-4 md:col-span-6 justify-center items-center pt-20 md:pb-20'>
                    <h1 className='md:text-6xl sm:text-2xl text-2xl py-6 font-light uppercase tracking-widest'>Conclusion</h1>
                    <TexasStripes />
