    ...
    return ( 
        <div className='w-full h-full bg-[#FFFDF6] px-4 font-sans'>
            ...
            <div className='grid grid-cols-12'>
                ...
                <div className='flex flex-col col-start-4 col-span-6 justify-center items-center pt-20 md:pb-20'>
                <CardTerms img={IntroCards.Adoption.img} altText={IntroCards.Adoption.altText} title={IntroCards.Adoption.title} description={IntroCards.Affordability.description} />
                </div>
            </div>
        </div>
     );
