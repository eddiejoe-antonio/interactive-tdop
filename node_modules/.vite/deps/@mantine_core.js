...
// node_modules/@mantine/core/esm/components/ScrollArea/ScrollAreaCorner/ScrollAreaCorner.mjs
var Corner = import_react44.default.forwardRef((props, ref) => {
  const { style, ...others } = props;
  const ctx = useScrollAreaContext();
  const [width, setWidth] = import_react44.default.useState(0);
  const [height, setHeight] = import_react44.default.useState(0);
  ...
  return hasSize ? import_react44.default.createElement("div", { ...others, ref, style: { ...style, width, height } }) : null;
});
var ScrollAreaCorner = import_react44.default.forwardRef(
  (props, ref) => {
    const ctx = useScrollAreaContext();
    const hasBothScrollbarsVisible = Boolean(ctx.scrollbarX && ctx.scrollbarY);
    const hasCorner = ctx.type !== "scroll" && hasBothScrollbarsVisible;
    return hasCorner ? import_react44.default.createElement(Corner, { ...props, ref }) : null;
  }
);
...
var Scrollbar = (0, import_react47.forwardRef)((props, forwardedRef) => {
  ...
  const [scrollbar, setScrollbar] = import_react47.default.useState(null);
  const composeRefs = useMergedRef(forwardedRef, (node) => setScrollbar(node));
  const rectRef = import_react47.default.useRef(null);
  const prevWebkitUserSelectRef = import_react47.default.useRef("");
...
var ScrollAreaScrollbarY = (0, import_react49.forwardRef)(
  (props, forwardedRef) => {
    const { sizes, onSizesChange, style, ...others } = props;
    const context = useScrollAreaContext();
    const [computedStyle, setComputedStyle] = import_react49.default.useState();
...
// node_modules/@mantine/core/esm/components/ScrollArea/ScrollAreaScrollbar/ScrollAreaScrollbar.mjs
var ScrollAreaScrollbar = import_react54.default.forwardRef(
  (props, forwardedRef) => {
    const { forceMount, ...scrollbarProps } = props;
    const context = useScrollAreaContext();
    ...
    return context.type === "hover" ? import_react54.default.createElement(ScrollAreaScrollbarHover, { ...scrollbarProps, ref: forwardedRef, forceMount }) : context.type === "scroll" ? import_react54.default.createElement(ScrollAreaScrollbarScroll, { ...scrollbarProps, ref: forwardedRef, forceMount }) : context.type === "auto" ? import_react54.default.createElement(ScrollAreaScrollbarAuto, { ...scrollbarProps, ref: forwardedRef, forceMount }) : context.type === "always" ? import_react54.default.createElement(ScrollAreaScrollbarVisible, { ...scrollbarProps, ref: forwardedRef }) : null;
  }
);
...
var ScrollAreaThumb = import_react55.default.forwardRef(
  (props, forwardedRef) => {
    const { forceMount, ...thumbProps } = props;
    const scrollbarContext = useScrollbarContext();
    if (forceMount || scrollbarContext.hasThumb) {
      return import_react55.default.createElement(Thumb, { ref: forwardedRef, ...thumbProps });
    }
    return null;
  }
);
...
var ScrollAreaViewport = (0, import_react56.forwardRef)(
  ({ children, style, ...others }, ref) => {
    ...
    return import_react56.default.createElement(
      ...
      import_react56.default.createElement("div", { style: { minWidth: "100%", display: "table" }, ref: ctx.onContentChange }, children)
    );
  }
);
...
var ScrollArea = factory((_props, ref) => {
  ...
  return import_react57.default.createElement(
    ...
    (scrollbars === "xy" || scrollbars === "x") && import_react57.default.createElement(
      ScrollAreaScrollbar,
      {
    ...
    (scrollbars === "xy" || scrollbars === "y") && import_react57.default.createElement(
      ScrollAreaScrollbar,
      {
        ...getStyles2("scrollbar"),
...
var Portal = (0, import_react67.forwardRef)((props, ref) => {
  ...
  return (0, import_react_dom5.createPortal)(import_react67.default.createElement(import_react67.default.Fragment, null, children), nodeRef.current);
});
...
function OptionalPortal({ withinPortal = true, children, ...others }) {
  if (withinPortal) {
    return import_react68.default.createElement(Portal, { ...others }, children);
  }
  return import_react68.default.createElement(import_react68.default.Fragment, null, children);
}
...
function useTransition({
  ...
  (0, import_react70.useEffect)(() => () => window.clearTimeout(timeoutRef.current), []);
  return {
    transitionDuration,
    transitionStatus,
...
function Transition({
  ...
  if (transitionDuration === 0) {
    return mounted ? import_react71.default.createElement(import_react71.default.Fragment, null, children({})) : keepMounted ? children({ display: "none" }) : null;
  }
  return transitionStatus === "exited" ? keepMounted ? children({ display: "none" }) : null : import_react71.default.createElement(import_react71.default.Fragment, null, children(
    getTransitionStyles({
      transition,
...
var PopoverDropdown = factory((_props, ref) => {
  ...
  return import_react72.default.createElement(OptionalPortal, { ...ctx.portalProps, withinPortal: ctx.withinPortal }, import_react72.default.createElement(
    Transition,
    {
      mounted: ctx.opened,
      ...ctx.transitionProps,
    ...
    (transitionStyles) => import_react72.default.createElement(FocusTrap, { active: ctx.trapFocus }, import_react72.default.createElement(
      Box,
      {
        ...accessibleProps,
        ...others,
...
var Dots = (0, import_react82.forwardRef)(({ className, ...others }, ref) => import_react82.default.createElement(Box, { component: "span", className: clsx_default(classes6.dotsLoader, className), ...others, ref }, import_react82.default.createElement("span", { className: classes6.dot }), import_react82.default.createElement("span", { className: classes6.dot }), import_react82.default.createElement("span", { className: classes6.dot })));

// node_modules/@mantine/core/esm/components/Loader/loaders/Oval.mjs
var import_react83 = __toESM(require_react(), 1);
var Oval = (0, import_react83.forwardRef)(({ className, ...others }, ref) => import_react83.default.createElement(Box, { component: "span", className: clsx_default(classes6.ovalLoader, className), ...others, ref }));
...
var InputLabel = factory((_props, ref) => {
  ...
  return import_react108.default.createElement(
    ...
    children,
    required && import_react108.default.createElement("span", { ...getStyles2("required"), "aria-hidden": true }, " *")
  );
});
...
var AccordionControl = factory((props, ref) => {
  ...
  const content = import_react118.default.createElement(
    UnstyledButton,
    {
      ...others,
    ...
    import_react118.default.createElement("span", { ...ctx.getStyles("label", { classNames, styles }) }, children),
    icon && import_react118.default.createElement(
      Box,
      {
        component: "span",
  ...
  return shouldWrapWithHeading ? import_react118.default.createElement(Heading, { ...ctx.getStyles("itemTitle", { classNames, styles }) }, content) : content;
});
...
var AccordionItem = factory((props, ref) => {
  ...
  const ctx = useAccordionContext();
  return import_react119.default.createElement(AccordionItemProvider, { value: { value } }, import_react119.default.createElement(
    Box,
    {
      ref,
...
var AccordionPanel = factory((props, ref) => {
  ...
  return import_react120.default.createElement(
    ...
    import_react120.default.createElement("div", { ...ctx.getStyles("content", { classNames, styles }) }, children)
  );
});
...
function AppShellMediaStyles({
  ...
  return import_react138.default.createElement(InlineStyles, { media, styles: baseStyles, selector: ctx.cssVariablesSelector });
}
...
var ComboboxClearButton = (0, import_react146.forwardRef)(
  ({ size: size2, onMouseDown, onClick, onClear, ...others }, ref) => import_react146.default.createElement(
    CloseButton,
    {
      ref,
      size: size2 || "sm",
...
var ComboboxDropdownTarget = factory((props, ref) => {
  ...
  return import_react148.default.createElement(Popover.Target, { ref, refProp }, children);
});
...
var ComboboxGroup = factory((props, ref) => {
  ...
  return import_react153.default.createElement(
    ...
    label && import_react153.default.createElement("div", { ...ctx.getStyles("groupLabel", { classNames, styles }) }, label),
    children
  );
});
...
var ComboboxTarget = factory((props, ref) => {
  ...
  return import_react158.default.createElement(Popover.Target, { ref: useMergedRef(ref, ctx.store.targetRef) }, clonedElement);
});
...
function useCombobox({
  ...
  const updateSelectedOptionIndex = (0, import_react159.useCallback)((target = "selected") => {
...
function Option({ data, withCheckIcon, value, checkIconPosition, unstyled }) {
  if (!isOptionsGroup(data)) {
    ...
    return import_react167.default.createElement(
      ...
      import_react167.default.createElement("span", null, data.label),
...
var ColorSwatch = polymorphicFactory((_props, ref) => {
  ...
  return import_react188.default.createElement(
    ...
    import_react188.default.createElement("span", { ...getStyles2("alphaOverlay") }),
    withShadow && import_react188.default.createElement("span", { ...getStyles2("shadowOverlay") }),
    import_react188.default.createElement("span", { ...getStyles2("colorOverlay", { style: { backgroundColor: color } }) }),
    import_react188.default.createElement("span", { ...getStyles2("childrenOverlay") }, children)
  );
});
...
var Thumb2 = (0, import_react190.forwardRef)(({ position, ...others }, ref) => import_react190.default.createElement(
  Box,
  {
    ref,
    __vars: {
...
var ColorSlider = factory((_props, ref) => {
  ...
  const layers = overlays.map((overlay, index5) => import_react191.default.createElement("div", { ...getStyles2("sliderOverlay"), style: overlay, key: index5 }));
...
function Saturation({
  ...
  return import_react194.default.createElement(
    ...
    import_react194.default.createElement(Thumb2, { position, ...getStyles2("thumb", { style: { backgroundColor: color } }) })
  );
}
...
var DrawerContent = factory((_props, ref) => {
  ...
  return import_react207.default.createElement(
    ...
    import_react207.default.createElement(Scroll, { style: { height: "100vh" } }, children)
  );
});
...
var DrawerRoot = factory((_props, ref) => {
  ...
  return import_react210.default.createElement(DrawerProvider, { value: { scrollAreaComponent, getStyles: getStyles2, radius } }, import_react210.default.createElement(
    ModalBase,
    {
      ref,
      ...getStyles2("root"),
...
var MenuDropdown = factory((props, ref) => {
  ...
  return import_react244.default.createElement(
    ...
    import_react244.default.createElement("div", { tabIndex: -1, "data-autofocus": true }),
    children
  );
});
...
var ModalContent = factory((_props, ref) => {
  ...
  return import_react253.default.createElement(
    ...
    import_react253.default.createElement(Scroll, { style: { maxHeight: `calc(100vh - (${rem(ctx.yOffset)} * 2))` } }, children)
  );
});
...
var ModalRoot = factory((_props, ref) => {
  ...
  return import_react256.default.createElement(ModalProvider, { value: { yOffset, scrollAreaComponent, getStyles: getStyles2 } }, import_react256.default.createElement(
    ModalBase,
    {
      ref,
      ...getStyles2("root"),
...
var PillGroup = factory((_props, ref) => {
  ...
  return import_react261.default.createElement(PillGroupProvider, { value: { size: _size, disabled } }, import_react261.default.createElement(Box, { ref, size: _size, ...getStyles2("group"), ...others }));
});
...
var Pill = factory((_props, ref) => {
  ...
  return import_react262.default.createElement(
    ...
    import_react262.default.createElement("span", { ...getStyles2("label") }, children),
    withRemoveButton && import_react262.default.createElement(
      CloseButton,
      {
        variant: "transparent",
        radius,
...
var PillsInput = factory((_props, ref) => {
  ...
  return import_react264.default.createElement(PillsInputProvider, { value: { fieldRef, size: size2, disabled, hasError: !!error, variant } }, import_react264.default.createElement(
    InputBase,
    {
      size: size2,
      error,
...
function PaginationIcon({ style, children, path, ...others }) {
  return import_react277.default.createElement(
    ...
    import_react277.default.createElement("path", { d: path, fill: "currentColor" })
  );
}
var PaginationNextIcon = (props) => import_react277.default.createElement(
  PaginationIcon,
  {
    ...props,
...
var PaginationPreviousIcon = (props) => import_react277.default.createElement(
  PaginationIcon,
  {
    ...props,
...
var PaginationFirstIcon = (props) => import_react277.default.createElement(
  PaginationIcon,
  {
    ...props,
...
var PaginationLastIcon = (props) => import_react277.default.createElement(
  PaginationIcon,
  {
    ...props,
...
var PaginationDotsIcon = (props) => import_react277.default.createElement(
  PaginationIcon,
  {
    ...props,
...
var PaginationDots = factory((_props, ref) => {
  ...
  const ctx = usePaginationContext();
  const Icon = icon;
  return import_react278.default.createElement(Box, { ref, ...ctx.getStyles("dots", { className, style, styles, classNames }), ...others }, import_react278.default.createElement(
    Icon,
    {
      style: {
        width: "calc(var(--pagination-control-size) / 1.8)",
...
function createEdgeComponent({ icon, name, action, type }) {
  ...
  const Component = (0, import_react279.forwardRef)((props, ref) => {
...
function PaginationItems({ dotsIcon }) {
  ...
  const items = ctx.range.map((page, index5) => {
    var _a;
    if (page === "dots") {
      return import_react280.default.createElement(PaginationDots, { icon: dotsIcon, key: index5 });
    }
  ...
  return import_react280.default.createElement(import_react280.default.Fragment, null, items);
}
...
var PaginationRoot = factory((_props, ref) => {
  ...
  return import_react281.default.createElement(
    ...
    import_react281.default.createElement(Box, { ref, ...getStyles2("root"), ...others })
  );
});
...
var ProgressRoot = factory((_props, ref) => {
  ...
  return import_react288.default.createElement(ProgressProvider, { value: { getStyles: getStyles2 } }, import_react288.default.createElement(Box, { ref, ...getStyles2("root"), ...others }));
});
...
var RadioGroup = factory((props, ref) => {
  ...
  return import_react292.default.createElement(RadioGroupProvider, { value: { value: _value, onChange: handleChange, size: size2, name: _name } }, import_react292.default.createElement(
    Input.Wrapper,
    {
      size: size2,
      ref,
    ...
    import_react292.default.createElement(InputsGroupFieldset, { role: "radiogroup" }, children)
  ));
});
...
function RadioIcon({ size: size2, style, ...others }) {
  return import_react293.default.createElement(
    ...
    import_react293.default.createElement("circle", { cx: "2.5", cy: "2.5", r: "2.5", fill: "currentColor" })
  );
}
...
var SegmentedControl = factory((_props, ref) => {
  ...
  const [initialized, setInitialized] = (0, import_react312.useState)(false);
...
var Thumb3 = (0, import_react319.forwardRef)(
  ({
    max: max2,
    min: min2,
    value,
    ...
    const { getStyles: getStyles2 } = useSliderContext();
    const [focused, setFocused] = (0, import_react319.useState)(false);
    ...
    return import_react319.default.createElement(
      ...
      import_react319.default.createElement(
        ...
        (transitionStyles) => import_react319.default.createElement("div", { ...getStyles2("label", { style: transitionStyles }) }, label)
      )
    );
  }
);
...
function Marks({ marks, min: min2, max: max2, disabled, value, offset: offset2, inverted }) {
  ...
  const items = marks.map((mark, index5) => import_react320.default.createElement(
    Box,
    {
    ...
    mark.label && import_react320.default.createElement("div", { ...getStyles2("markLabel") }, mark.label)
  ));
  return import_react320.default.createElement("div", null, items);
}
...
function Track({
  ...
  const { getStyles: getStyles2 } = useSliderContext();
  return import_react321.default.createElement(import_react321.default.Fragment, null, import_react321.default.createElement(Box, { ...getStyles2("trackContainer"), mod: { disabled }, ...containerProps }, import_react321.default.createElement(Box, { ...getStyles2("track"), mod: { inverted, disabled } }, import_react321.default.createElement(
    Box,
    {
  ...
  ), children, import_react321.default.createElement(Marks, { ...others, offset: marksOffset, disabled, inverted }))));
}
...
var varsResolver80 = createVarsResolver((_, { order, size: size2, lineClamp }) => {
